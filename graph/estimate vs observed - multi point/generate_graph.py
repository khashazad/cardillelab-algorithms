...
data = pd.read_csv(os.path.relpath("./graph/estimate vs observed - multi point/eeek_output.csv"))
data_original = pd.read_csv(os.path.relpath("./graph/estimate vs observed - multi point/original.csv"))
