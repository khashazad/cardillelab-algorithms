...
from utils.pest_file_builder import create_control_file, append_observations_to_control_file, create_instructions_file, append_model_and_io_sections_to_control_file, create_template_file, create_model_file
...
if __name__ == "__main__":
    ...
    create_control_file(read_json(parameters), control_filename, len([x for x in observations if x[1] != 0]))
    append_observations_to_control_file(observations, control_filename, OBSERVATIONS_FLAGS)
