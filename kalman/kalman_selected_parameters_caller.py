...
from utils.filesystem import delete_and_create, read_file
...
parent_run_directory = f"{script_directory}/kalman/runs/set {POINT_SET} - {POINTS_COUNT} points/version {VERSION}/"
...
def analyze_results(run_directory):
    ...
    delete_and_create(analysis_directory)
...
if __name__ == "__main__":
    ...
    parameter_sets_directory = os.path.join(
        script_directory, "kalman", "runs", "parameter set", "selected"
    )
